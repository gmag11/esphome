...
namespace esphome {
  namespace hlw8012 {
    ...
    void HLW8012Component::update () {
      ...
      // static int32_t voltage_cycle = 0;
      // static int32_t current_cycle = 0;
      ...
      // TODO: Add apparent power

      // TODO: Add reactive power

      // TODO: Add power factor

      if (this->current_mode_) {
        ESP_LOGV (TAG, "Current Mode");
        if (this->change_mode_at_++ == this->total_current_cycles_) {
