...
namespace esphome {
  namespace hlw8012 {
    ...
    void HLW8012Component::dump_config () {
      ...
      ESP_LOGCONFIG (TAG, "  Voltage resistor upstream: %u Ω", this->voltage_resistor_upstream_);
      ESP_LOGCONFIG (TAG, "  Voltage resistor downstream: %u Ω", this->voltage_resistor_downstream_);
      ESP_LOGCONFIG (TAG, "  Voltage Divider: %.1f", this->voltage_divider_);
      ESP_LOGCONFIG (TAG, "  Voltage Multiplier: %u", this->voltage_multiplier_);
      ESP_LOGCONFIG (TAG, "  Current Multiplier: %u", this->current_multiplier_);
      ESP_LOGCONFIG (TAG, "  Power Multiplier: %u", this->power_multiplier_);
